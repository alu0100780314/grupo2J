...
\begin{definicion}
	La principal motivación de realizar este trabajo es terminar de  manejar bien el LaTeX ,Beamer y Python, 
y comprender bien al acabar el trabajo en que consistes todo el Método de Simpson.
\end{definicion}
