...
Se puede decir que uno de los problemas más frecuentes en las matemáticas es el cálculo del área que se obtiene a 
apartir de una funcion f(x), el eje x y los límites a y b.Por ejemplo, si se quiere calcular el área de la figura 1, 
hay que recalcar que dicha área está comprendida entre los límites a y b, y por debajo de la funcion f(x):
 
%\begin{center}
%\includegraphics[width=0.2\textwidth]{mem/images/imagen1}\\[0.25cm]
%\end{center}

Partiendo de que se conoce la función y los valores de a y b; considerándose b como el límite superior y a como el inferior, se 
...
Respecto a estos tipos de soluciones se sabe de antemano que las solcuiones algebraicas son mejores que las numéricas, dado que son exactas. Pero se da el caso de que a veces, la complejidad de las funciones hace difícil la obtención de la solución algebraica, por lo que la solción numérica permite ahorrar tiempo. Como ejemplo de esta aproximación se tiene el Método de Simpson.
