...
Para dicha resolcuión se parte de que se conoce la funcion f(x) y los valores de a y b, considerando a tales valores, el límite inferior y el límite superior, respectivamente. Tras aver realizado dicho cálculo se puede llegar a obtener dos tipos de soluciones:
