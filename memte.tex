...
\HRule
\begin{center}
        {\Huge Método de Simpson} \\[2.5mm] 
        {\Huge Integración numérica} \\[2.5mm]
        {\Large Iván Trujillo Trujillo \\
...
% ha puesto.
\markboth{Iván Trujillo y Samuel Lucas}{Método de Simpson}
...
\input{mem/tex/cap3.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Conclusiones}
\label{chapter:conclusiones}

\input{mem/tex/cap4.tex}
...
\bibliography{mem/tex/bibliografia}
\nocite{*}
